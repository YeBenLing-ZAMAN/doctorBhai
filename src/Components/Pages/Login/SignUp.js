import React from 'react'; import { useCreateUserWithEmailAndPassword, useSignInWithGoogle, useUpdateProfile } from 'react-firebase-hooks/auth';
        ...
        <div className='h-screen flex justify-center items-center'>
            <div className="card w-96 bg-base-100 shadow-xl p-5">
                <div className="card-body">
                    ...
                    <p><small>Already Have a account?<Link to='/login' className='text-primary'>Login</Link></small></p>
                </div>
