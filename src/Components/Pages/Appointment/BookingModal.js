        ...
        <div>
            ...
            <div class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                    ...
                    <h3 class="font-bold text-2xl mb-5 text-center">Booking for : <span className='text-primary'>{name}</span> </h3>
                    {/* input form */}
                    <form onSubmit={handleBooking} className='grid  grid-cols-1 gap-3 justify-items-center mt-2'>
                        ...
                        <input type="submit" placeholder="Submit" class="btn btn-secondary bg-gradient-to-r from-primary to-secondary w-full max-w-xs" />
                    </form>
                </div>
            </div>
        </div>
